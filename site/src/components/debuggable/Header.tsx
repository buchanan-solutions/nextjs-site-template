...
// ./src/components/debuggable/Header.tsx
...
type DebuggableHeaderProps = React.ComponentPropsWithRef<"header"> & {
  debug?: boolean;
};

const DebuggableHeader = forwardRef<HTMLElement, DebuggableHeaderProps>(
  ({
    ...
    if (!debug) {
      return (
        <header ref={ref} id={id} className={className} {...rest}>
          {children}
        </header>
      );
    }
...
DebuggableHeader.displayName = "DebuggableHeader";

export default DebuggableHeader;